import { c as createWebWorker, e as editor, U as Uri, a as MarkerTag, M as MarkerSeverity, l as languages, t as typescriptDefaults, R as Range } from "./App-DjVLpUQl.js";
      ...
      this._client = (async () => {
        this._worker = createWebWorker({
          ...
          createWorker: () => new Worker(new URL(
            /* @vite-ignore */
            "" + new URL("ts.worker-CL8L56yC.js", import.meta.url).href,
            import.meta.url
          ), { type: "module" }),
          label: this._modeId,
          keepIdleModels: true,
