(function() {
  ...
  let FoldingRangeKind$1 = class FoldingRangeKind2 {
    static {
      this.Comment = new FoldingRangeKind2("comment");
    }
    static {
      this.Imports = new FoldingRangeKind2("imports");
    }
    static {
      this.Region = new FoldingRangeKind2("region");
    }
    /**
    ...
    static fromValue(value) {
      ...
      return new FoldingRangeKind2(value);
    }
    /**
  ...
  let Color$1 = class Color2 {
    ...
    static {
      this.white = new Color2(new RGBA(255, 255, 255, 1));
    }
    static {
      this.black = new Color2(new RGBA(0, 0, 0, 1));
    }
    static {
      this.red = new Color2(new RGBA(255, 0, 0, 1));
    }
    static {
      this.blue = new Color2(new RGBA(0, 0, 255, 1));
    }
    static {
      this.green = new Color2(new RGBA(0, 255, 0, 1));
    }
    static {
      this.cyan = new Color2(new RGBA(0, 255, 255, 1));
    }
    static {
      this.lightgrey = new Color2(new RGBA(211, 211, 211, 1));
    }
    static {
      this.transparent = new Color2(new RGBA(0, 0, 0, 0));
    }
  };
  (function(Color2) {
    (function(Format) {
  ...
  function getSelectionRanges(document2, positions, doc) {
    ...
    function newRange(start2, end) {
      return Range.create(document2.positionAt(start2), document2.positionAt(end));
    }
    const scanner = createScanner(document2.getText(), true);
